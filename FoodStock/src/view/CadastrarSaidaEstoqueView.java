...
public class CadastrarSaidaEstoqueView extends javax.swing.JFrame {
    ...
    private void jBtnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConfirmarActionPerformed
        ...
        boolean inserido = clienteController.adicionarCliente(nome, cpfCnpj, email, telefone,
                logradouro, bairro, numero,
                cep, municipio, estado, pais);

        if (inserido) {
            JOptionPane.showMessageDialog(null, "Cliente inserido com sucesso.", "Confirmação", JOptionPane.INFORMATION_MESSAGE);
            limparCampos();  
        } else {
